#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════════════════
# Qwen3-8B Eagle3 SDDD — Docker Launch (vLLM + Mooncake TCP, MI308)
#
# GPU split (8x MI308):
...
CONTAINER_NAME="qwen3_8b_eagle3_vllm_mi308"
LUMENRL_DIR="/home/leiwu/Lumen-RL"

if [ "${SMOKE_TEST}" = true ]; then
    RUN_CMD="bash examples/Qwen3_8B_SDDD_MI308_vLLM/run_qwen3_8b.sh --smoke-test"
    echo "═══════════════════════════════════════════════════════════════"
    echo "  Qwen3-8B Eagle3 Smoke Test (Docker) — vLLM, MI308"
    echo "  Image:    ${DOCKER_IMAGE}"
    echo "  GPUs:     8x MI308 (0-3 training, 4-7 inference)"
    echo "  Transfer: Mooncake TCP"
    echo "═══════════════════════════════════════════════════════════════"
else
    RUN_CMD="bash examples/Qwen3_8B_SDDD_MI308_vLLM/run_qwen3_8b.sh"
    echo "═══════════════════════════════════════════════════════════════"
    echo "  Qwen3-8B Eagle3 Training (Docker) — vLLM, MI308"
    echo "  Image:    ${DOCKER_IMAGE}"
    echo "  GPUs:     8x MI308 (0-3 training, 4-7 inference)"
    echo "═══════════════════════════════════════════════════════════════"
fi
